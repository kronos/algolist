...
TEST(Long, PlusEqual) {
    ...
    // two mixed numbers
    EXPECT_EQ("-100000000000000000000000000", (L("0")  += L("-100000000000000000000000000")).to_string());
    EXPECT_EQ("-99999999999999999999999999", (L("1")  += L("-100000000000000000000000000")).to_string());
    EXPECT_EQ("99999999999999999999999999",  (L("-1") += L("100000000000000000000000000")).to_string());
    EXPECT_EQ("99999999999999999999999999",  (L("100000000000000000000000000")  += L("-1")).to_string());
    EXPECT_EQ("-99999999999999999999999999", (L("-100000000000000000000000000") += L("1")).to_string());
    ...
    //self
    Long t(0);
    EXPECT_EQ("0", (t += t).to_string());
    t = L("1");
    EXPECT_EQ("2", (t += t).to_string());
    t = L("-1");
    EXPECT_EQ("-2", (t += t).to_string());
    t = L("999999999");
    EXPECT_EQ("1999999998", (t += t).to_string());
}
...
TEST(Long, MultiplyEqual) {
    ...
    EXPECT_EQ("0", (t *= t).to_string());
    t = L("1");
    EXPECT_EQ("1", (t *= t).to_string());
    t = L("-1");
    EXPECT_EQ("1", (t *= t).to_string());
    t = L("9999999999");
    EXPECT_EQ("99999999980000000001", (t *= t).to_string());
}
